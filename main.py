...
def main():
    ...
    len(sorted_lines)
    print('+'*50)
    for i in range(len(sorted_lines)-1, len(sorted_lines) - 3, -1):
    #for i in range(0, len(copy_sorted_lines) -1):       
        ...
        line_min_x_cord = sorted_line[0][1][0] #top left x cord of first word of current line
        line_max_x_cord = sorted_line[-1][1][1] #top right x cord of last word of current line
        ...
        print(line_min_x_cord)
        print(line_max_x_cord)

        #if(middle_x_cord not in x_nums and line_middle_x_cord not in x_nums):
